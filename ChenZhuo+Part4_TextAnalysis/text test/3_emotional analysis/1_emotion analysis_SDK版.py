...
"""
APP_ID = '116031072'
API_KEY = 'AJQKGekCl6gGp03GViGRQ0vj'
SECRET_KEY = 'ozrk7Eas6VPPiF78sbrD9pXmGJKVka1K'
...
def extract(inpath):
    ...
    for i in range(1, nrows):#第0行为表头
        ...
        result_1 = alldata[3]#取出日期
        result_3 = alldata[4]#取出地区
        result_2 = alldata[5]#取出评论内容
        numbers.append([result_1,result_3,result_2])
        # numbers.append(result_2)
    return numbers

# alls=[]#大列表
# all=extract('D:/Desktop/grade 1/DEDA/HW/text analysis/text test/3_emotional analysis/redsea.xlsx')
# print(all)
...
if __name__ == "__main__":
    save_file(run('D:/Desktop/grade 1/DEDA/HW/text analysis/text test/3_emotional analysis/coastline.xlsx'),'coastline_emotional.xlsx')
